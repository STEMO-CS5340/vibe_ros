...
class StereoCameraPublisher
{
    public:
        ...
        void publish(const cv::Mat imageLeft_cv,const cv::Mat imageRight_cv, const std::string encoding, sensor_msgs::CameraInfo cameraInfo_left, sensor_msgs::CameraInfo cameraInfo_right, const ros::Time sensor_timestamp);
    private:
        ros::NodeHandle _nh;
